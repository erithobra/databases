...
COPY departments(dept_name,emp_id) FROM '/Users/alex/workspaces/GA-Cognizant/databases/sql-joins-lesson/starter-code/departments.csv' DELIMITER ',' CSV HEADER;
